...
def summarize():
    try:
        ...
        summary_pdf_path, summary_file_name = create_summary_pdf(summary, title, prompt)
        summary_link = upload_to_drive_with_doc_type(summary_pdf_path, summary_file_name, "要約", doc_type)
